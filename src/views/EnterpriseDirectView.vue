  ...
  <div class="application-resources-page">
    ...
    <section class="jobs-section">
      <div class="container">
        ...
        <!-- 分页 -->
        <PaginationPage v-model:PaginationData="paginationData" :loading="loading" :source="filterSource" @change="handlePageChange"></PaginationPage>
      </div>
    </section>
...
import { getRecommendJobList, getFilterOptions } from '@/api'
